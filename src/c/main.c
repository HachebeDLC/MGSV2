...
//
// Measured from bgv2.2.png rather than guessed. tools/trim_case.py cuts the
// two printed case bands off the top and bottom of the original art, so every
// y below is 8 lower than it was when the case was still there:
...
#define LY_MARK_W      2
#define LY_MARK_H      7
#define LY_MARK_CHA    4   // charging
#define LY_MARK_ALM    14   // quiet time
#define LY_MARK_DATA   25   // phone connected
#define LY_MARK_PWRS   36   // power saving
#define LY_MARK_IMPL   47   // Fahrenheit

// Steps live in the rail's one empty box.
#define LY_STEPS_X     117
#define LY_STEPS_Y     63
